...
-- is ``1.26-09-04-3``: a major, then the release date. PEP 440 has no way to
spell a hyphenated date, so the two ``pyproject.toml`` files carry the same
date as ``1.26.9.4.3``, which is what ``pip``/``uv`` see in the wheel metadata.
Release tags are ``v1.26-09-04-3``.
...
DISPLAY_VERSION = "1.26-09-04-3"
#: The same date, as the only thing PEP 440 will accept.
PEP440_VERSION = "1.26.9.4.3"
