...
Expected: `{"status":"ok","version":"0.2.0",...}` — the version comes from this repository's
`pyproject.toml`. A dated string such as `1.26-08-23` means a private build on a different release
line, and these instructions may not match it.
