...
It merges two upstream tool sets into one list of **24 tools**:

| Source | Tools | Works when the main server is wedged? |
| --- | --- | --- |
| Main app (14) | `list_models`, `model_options`, `model_info`, `load_model`, `unload_model`, `test_model`, `search_models`, `repo_details`, `download_model`, `delete_model`, `server_status`, `connection_info`, `get_config`, `set_config` | no |
